---
title: "Building Modular and Dynamic Interfaces for the Web"
publishedAt: "2024-04-08"
summary: "This project focuses on the development of scalable, reusable, and responsive UI components tailored for modern web applications. By leveraging technologies like React, Next.js, and Tailwind CSS, it emphasizes creating dynamic interfaces that adapt seamlessly across devices."
images:
  - "/images/projects/project-01/flourishers-edge.png"
  - "/images/projects/project-01/hind-convent.png"
  - "/images/projects/project-01/flourishers-edge.png"
  - "/images/projects/project-01/nova-upvc.png"
team:
  - name: "Selene Yu"
